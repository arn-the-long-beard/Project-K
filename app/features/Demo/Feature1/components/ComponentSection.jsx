...
import ResultsList from './ComponentResultsList'
import SeekSettingsMenu from './ComponentSetting'
...
const ResultsSection = ({results, update, message, isRequesting, maxResults, onChange}) => (
  ...
  <section className={styles.container}>
    <div><h4 className={styles.titleSection}> Smell how you are stinky <Search color={blue500} /> {isRequesting &&
    <MiniLoader />}</h4></div>
